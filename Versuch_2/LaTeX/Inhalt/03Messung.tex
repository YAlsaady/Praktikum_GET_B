\section{Messungen}
    ...
    \end{table}
      ...
      \pagebreak
	 		...
	 		In Bezug auf die Sternkompensation konnten wir keine Kompensation mit den $4 \mu F$ Kondensatoren feststellen, wie in Abbildung \ref{img3.3.8} dargestellt ist. Dies liegt daran, dass zwischen der Stern- und Dreieckkompensation ein Faktor von 3 besteht. Um eine Kompensation der Phasenverschiebung zu erreichen, müsste daher ein $12 \mu F$ Kondensator verwendet werden.
