	...
	\subsection{Fehlerstromschutzschalter zum Personenschutz}
 	...
 	\subsection{Symmetrische Drehstromlast ohne/mit Kompensation}
	 	\begin{enumerate}[label=\alph*)]
	 		...
	 		\textbf{Die Aussage muss überarbeite werden, da die nicht unser Case abdeckt.}
	 		\newline
	 		Kompensation in Dreieckschaltung: Bei der Kompensation in Dreieckschaltung werden die Kondensatoren in einer Dreieckschaltung parallel zu den Lasten geschaltet. Dies hat den Vorteil, dass sie in Reihe mit den Induktivitäten der Lasten stehen. Diese Konfiguration führt dazu, dass die Kondensatoren die Blindleistung der Lasten direkt kompensieren. Dies ist besonders wirksam, wenn die Lasten in Dreieckschaltung geschaltet sind oder wenn die Verdrahtung so angeordnet ist, dass die Kondensatoren in Reihe mit den Lasten geschaltet werden können.
	 		\newline
	 		Kompensation in Sternschaltung: Die Kompensation in Sternschaltung erfolgt, indem die Kondensatoren parallel zu den Lasten, jedoch in Sternschaltung geschaltet werden. Dies hat den Vorteil, dass die Spannung über jedem Kondensator niedriger ist als die Gesamtphasenspannung, was die Lebensdauer der Kondensatoren verlängern kann. Diese Konfiguration ist nützlich, wenn die Lasten in Sternschaltung geschaltet sind oder wenn es keine Möglichkeit gibt, die Kondensatoren in Reihe mit den Lasten zu schalten.
